...
const gov = db.gov
const Audit = gov.import('../schema/LIM_AuditLog.js')//审核记录
const kak = gov.import('../schema/Lim_kakInfo.js')//卡口信息
const LS_FS_report = gov.import('../schema/Lim_LS_FS_report.js')//人员信息
...
Deps.hasMany(LS_FS_report,{foreignKey:'JdId',sourceKey:'DepartmentId' ,as:'PersonList'});//area和Permission 表 1对多
...
class PersonInfomationModel {

     static async selectByJD_Id(data)
     {
      let pagesize = 10;
      let curpage = 1;
      ...
      if(data)
      {
        const PersonInfo=await LS_FS_report.findAndCountAll(
          {
              limit: data.limit,
              offset:data.offset,
            where:{
        ...
        // const PersonInfo=await Deps.findAndCountAll({
        //   // limit: pagesize,
        ...
        //   }],
          ...
          // Sequelize.col('PersonList.ReportId'),   
          // Sequelize.col('PersonList.name'),   
          // Sequelize.col('PersonList.tel'),
          // Sequelize.col('PersonList.idcard'),   
          // Sequelize.col('PersonList.juzhuType'),   
          // Sequelize.col('PersonList.CunSheQu'),      
          // Sequelize.col('PersonList.xiaoQu'), 
          // Sequelize.col('PersonList.louDong'),   
          // Sequelize.col('PersonList.fangHao'),   
          // Sequelize.col('PersonList.inputTime'),   
          // Sequelize.col('PersonList.sex')       
          // order:[
          //   // ['ReportId','DESC']
          //    [Sequelize.col('PersonList.ReportId'), 'DESC']
          // ],
          // limit: data.limit,                      // 每页多少条
          // offset:data.offset, // 跳过多少条
            //  raw:true
...
module.exports = PersonInfomationModel
